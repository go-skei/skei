...
import (
	...
	"code.skei.dev/skei/modules/detaillevel"
	"code.skei.dev/skei/modules/gzip"
	"code.skei.dev/skei/modules/lfs"
	"code.skei.dev/skei/modules/log"
	"code.skei.dev/skei/modules/metrics"
	"code.skei.dev/skei/modules/options"
	"code.skei.dev/skei/modules/public"
	"code.skei.dev/skei/modules/setting"
	"code.skei.dev/skei/modules/templates"
	"code.skei.dev/skei/modules/validation"
	"code.skei.dev/skei/routers"
	"code.skei.dev/skei/routers/admin"
	apiv1 "code.skei.dev/skei/routers/api/v1"
	"code.skei.dev/skei/routers/dev"
	"code.skei.dev/skei/routers/org"
	"code.skei.dev/skei/routers/private"
	"code.skei.dev/skei/routers/repo"
	"code.skei.dev/skei/routers/user"
	userSetting "code.skei.dev/skei/routers/user/setting"
